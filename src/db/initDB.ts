...
const initDB = async () => {
    ...
    try {
        ...
        await client.query(`CREATE INDEX IF NOT EXISTS games_question_num_idx ON games (question_num);`, []);
        ...
        await client.query(`CREATE INDEX IF NOT EXISTS questions_game_id_idx ON questions (game_id);`, []);
